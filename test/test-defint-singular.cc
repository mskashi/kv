...
// \int_S^1 sqrt{1 - x^2} dx
// = \int_0^{1-S} \sqrt{y}\sqrt(2 - y) dy
...
int main() {
	...
	r1 = kv::defint_autostep(Func1(), (itv)0., (itv)1. - FUNC1_TH, 12);
	r2 = kv::defint_power(Func1_s(), (itv)0., (itv)FUNC1_TH, 12, (itv)0.5);
